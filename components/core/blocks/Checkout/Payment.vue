    ...
    <div class="row pl20" v-if="isActive">
      ...
      <div class="col-xs-11 col-sm-9 col-md-10">
        <div class="row" v-if="isActive">
          ...
          <div v-for="(method, index) in pspPaymentMethods" :key="index" class="col-md-6">
            <label class="radioStyled">
              <span class="payment-method-icon">
                <img :src="method.image.svg" :alt="method.title ? method.title : method.name" width="30">
              </span>
...
import iDealIssuers from 'src/modules/vsf-payment-service/components/iDealIssuers'
...
export default {
  ...
  computed: {
    ...
    pspPaymentMethods () {
      return pickBy(this.paymentMethods, (paymentMethod) => { return (paymentMethod.pspMethod) })
    },
    isIdeal () {
